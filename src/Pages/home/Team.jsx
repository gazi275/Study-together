...
const Team = () => {
    return (
        <div >
            <section className="py-6 bg-gray-800 text-gray-100" style={{backgroundImage:'url("https://i.ibb.co/HhLBwyh/images-3.jpg")'}}>
	<div className="container flex flex-col items-center justify-center p-4 mx-auto sm:p-10">
		<p className="p-2 text-sm font-bold tracki text-center uppercase text-black">Development team</p>
		<h1 className="text-4xl font-bold leadi text-center sm:text-5xl text-black">The talented people behind the scenes</h1>
