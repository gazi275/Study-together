...
const Animattion = () => {
    return (
        <div className='w-full' style={{ backgroundImage: 'url("https://i.ibb.co/tBvVpMm/images-1.jpg")' }}>

<div className='flex justify-center items-center gap-5 my-10 mx-auto'  > 
